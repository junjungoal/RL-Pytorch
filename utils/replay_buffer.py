...
class ReplayBuffer:
    ...
    def __init__(self, action_space_size, state_size, imsize, buffer_size=1e5):
    ...
    def get_minibatch(self, batch_size=32, shuffle=True):
        ...
        return np.array(prestates, dtype=np.float32), actions, rewards, np.array(states, dtype=np.float32), terminals
